...
namespace cnzhnet.music_decrypt.Services
{
    ...
    /// 用于规定实现流解密的实现接口.
    /// </summary>
    public interface IStreamDecrypter
    {
        /// <summary>
        /// 表示要解密的源数据流（即解密该流）.
        /// </summary>
    ...
    public class CompletedEventArgs : EventArgs
    {
        ...
        /// <param name="output">输出的文件完整路径</param>
        /// <param name="err">错误信息（若成功时则应为 null）.</param>
        public CompletedEventArgs(bool _success, string _id, Exception err = null)
        {
            Success = _success;
            Id = _id;
            Error = err;
    ...
    /// <param name="e"></param>
    public delegate void CompletedEventHandler(IStreamDecrypter sender, CompletedEventArgs e);
}
